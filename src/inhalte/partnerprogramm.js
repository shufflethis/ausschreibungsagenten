export const partnerprogramm = {
    ...
    direktantwort:
        'Das Partnerprogramm von Ausschreibungsagenten vergütet Empfehlungen, die zu einem Vertragsabschluss führen. Sie erhalten einen persönlichen Empfehlungslink, die Zuordnung gilt dreißig Tage ab dem ersten Klick, und die Provision wird auf den Bruttoumsatz berechnet — bei laufenden Abonnements auch auf Folgezahlungen. Voraussetzung ist, dass der Empfohlene der Speicherung zustimmt.',
    fakten: {
        datenstand: '20. August 2026',
        kopf: ['Merkmal', 'Regelung'],
        zeilen: [
            ['Vergütungsmodell', 'Anteil am Bruttoumsatz inklusive Umsatzsteuer'],
    ...
    faq: [
        {
            ...
            antwort: 'Der Prozentsatz wird je Partner in den Teilnahmebedingungen festgelegt und bezieht sich auf den Bruttoumsatz einschließlich Umsatzsteuer. Bei Abonnements fällt er wiederkehrend an, solange der empfohlene Vertrag läuft. Sprechen Sie uns an, dann nennen wir Ihnen die Konditionen für Ihr Umfeld.',
        },
        {
